<template>
<el-dialog title="提示" :visible.sync="visible" size="small" :show-close='false'>
...
export default {
    ...
    methods: {
        ...
        async getRecentMessages() {
            const res = await getRecentMessages(this.$store.state.user, this.$store.state.selectTargetUser)
