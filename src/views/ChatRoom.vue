...
<div class="chat-room">
    ...
    <div class="content-box">
        <div class="online-user">
            ...
            <OnlineUser v-for="item in this.$store.state.onlineUser" v-bind:key="item" :name="item" />
        </div>
        <div class="chat-box">
            ...
            <div class="chat-option">
                <RecentMsgModal ref="recentMsg" :visible="recentMsgModal" :setVisible="setRecentDialogVisible" />
                <el-button @click="setRecentDialogVisible">聊天记录</el-button>
            </div>
            <div class="user-input-container">
                <div class="chat-msg-input">
                    <el-input type="textarea" :rows="4" :count="100" :debounce='2' placeholder="请输入信息" v-model="msg" @keyup.enter.native="handleSend"></el-input>
                </div>
...
export default {
    ...
    methods: {
        ...
        setRecentDialogVisible() {
            this.recentMsgModal = !this.recentMsgModal
            if (this.recentMsgModal == true) {
                this.$refs.recentMsg.getRecentMessages()
            }
        },
        closeWebsocket() {
            if (this.ws) {
